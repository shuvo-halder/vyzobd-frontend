      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          {[1, 2, 3].map((n) => (
            <div
              key={n}
              className="h-32 bg-white rounded-xl border border-primary/10 animate-pulse"
            />
          ))}
        </div>
      </div>
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white p-8 sm:p-12 rounded-xl border border-primary/10 shadow-sm text-center max-w-md mx-auto">
          ...
          <Link
            href="/products"
            className="inline-flex items-center gap-2 bg-accent text-white text-xs font-bold uppercase tracking-widest px-6 py-3 rounded-md hover:bg-primary transition-all shadow-sm"
          >
      ...
      <div className="border-b border-primary/10 pb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-primary/60 mt-1">
            View your order history, delivery statuses, and invoices.
          </p>
        </div>
        <div className="text-xs text-primary/70 font-bold bg-white px-4 py-2 rounded-full border border-primary/10 self-start sm:self-auto">
      ...
      <div className="space-y-6">
        {orders.map((order) => {
          ...
          return (
            <div
              key={order._id}
              className="bg-white rounded-xl border border-primary/10 shadow-sm overflow-hidden transition-all hover:border-primary/20"
            >
              ...
              <div className="p-5 sm:p-6 bg-secondary/30 border-b border-primary/10 flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    className="p-1 text-primary/70 hover:text-primary transition-colors flex items-center gap-1 text-xs font-semibold"
                  >
              ...
              <div className="p-5 sm:p-6">
                ...
                {isExpanded && (
                  <div className="mt-6 pt-6 border-t border-primary/10 grid grid-cols-1 md:grid-cols-2 gap-6 bg-secondary/20 p-4 sm:p-6 rounded-lg">
                    {/* Shipping Address */}
                    <div>
